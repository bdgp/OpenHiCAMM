...
public class AFOptionsDlg extends JPanel {
   JTextField sizeFirstField_;
   JTextField numFirstField_;
   JTextField sizeSecondField_;
   JTextField numSecondField_;
   JTextField cropSizeField_;
   JTextField thresField_;
   JTextField channelField_;
    ...
    * Create the dialog
    */
    public AFOptionsDlg(AutoFocus af) {//constructor
      super();
      af_ = af;
      this.setLayout(null);
